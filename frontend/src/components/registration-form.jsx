...
export function RegistrationForm({ role, onBack }) {
  ...
  const handleFindMatches = () => {
    ...
    setTimeout(() => {
      setMatches([
        { id: 1, name: "Aster T.", experience: "5 years experience", location: "Addis Ababa", match: 98, verified: true, skills: ["Cleaning", "Cooking", "Childcare"], image: "https://images.unsplash.com/photo-1531123897727-8f129e1eb4ce?w=400&q=80" },
        { id: 2, name: "Mekdes A.", experience: "3 years experience", location: "Addis Ababa", match: 92, verified: true, skills: ["Cleaning", "Laundry"], image: "https://images.unsplash.com/photo-1544005313-94ddf0286df2?w=400&q=80" },
        { id: 3, name: "Helen B.", experience: "2 years experience", location: "Bahir Dar", match: 85, verified: false, skills: ["Cooking", "Elderly Care"], image: "https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=400&q=80" }
      ]);
